  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-primary via-primary to-accent text-white shadow-lg shadow-primary/25 hover:brightness-110 hover:shadow-xl hover:shadow-primary/30 hover:scale-[1.02]",
        hero:
          "bg-foreground text-background shadow-xl shadow-foreground/20 hover:bg-foreground/90 hover:shadow-2xl hover:scale-[1.02] font-bold",
        "hero-outline":
          "border-2 border-foreground/30 bg-background backdrop-blur-sm text-foreground hover:bg-muted hover:border-foreground transition-all",
        success:
