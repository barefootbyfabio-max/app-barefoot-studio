-- Corrigir ambiguidade qualificando TODAS as referências à tabela
-- Usando prefixo da tabela em todas as colunas
...
BEGIN
  ...
  -- Qualificar TODAS as colunas com prefixo da tabela
  INSERT INTO public.credit_transactions AS ct (student_id, week_start, credits_used, credits_total)
